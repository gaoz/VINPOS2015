 ...
 * @author vinson
 */
public class JDquantity extends javax.swing.JDialog {

    /**
     * Creates new form seperateCheckJD
     */
    public JDquantity(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("or enter a bigger number here");
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        try{
            if(number>0){
                ...
                JOptionPane.showMessageDialog(null,"Please enter numbers only 1~100");
            }
